<?php $pageTitle='Edit Patient'; require __DIR__.'/../partials/header.php';?>

<div style="max-width:900px">
  <div class="flex justify-between items-center" style="margin-bottom:1.25rem">
    <h2 style="font-size:1.1rem;font-weight:600">✏️ Edit Patient — <?=e($patient['patient_id'])?></h2>
    <a href="<?=BASE_URL?>/patients/<?=$patient['id']?>" class="btn btn-secondary btn-sm"><i class="fa fa-arrow-left"></i> Back</a>
  </div>

  <form method="POST" action="<?=BASE_URL?>/patients/<?=$patient['id']?>/update" enctype="multipart/form-data">
      ...
      <div class="card-body">
        <div class="form-grid">
          ...
          <div class="form-group">
            ...
            <input type="date" name="date_of_birth" value="<?=e($old['date_of_birth']??'')?>" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <img src="<?=asset('uploads/'.$patient['photo'])?>" style="width:50px;height:50px;border-radius:50%;object-fit:cover;margin-bottom:.5rem">
            <?php endif;?>
      ...
      <div class="card-body">
        <div class="form-grid">
          ...
          <div class="form-group">
            <label>Status</label>
            <select name="status">
              <?php foreach(['active'=>'Active','critical'=>'Critical','under_observation'=>'Under Observation','discharged'=>'Discharged'] as $v=>$l):?>
          ...
          <div class="form-group full">
            <label>Notes</label>
            <textarea name="notes"><?=e($old['notes']??'')?></textarea>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="flex gap-2">
      ...
      <a href="<?=BASE_URL?>/patients/<?=$patient['id']?>" class="btn btn-secondary">Cancel</a>
    </div>
  </form>
</div>
